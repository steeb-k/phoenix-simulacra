...
pub struct Settings {
    ...
    /// Grab input while the pointer is over the QEMU window, so guest
    /// hotkeys reach the guest. Off by default, as in QEMU.
    pub vm_grab_keyboard: bool,

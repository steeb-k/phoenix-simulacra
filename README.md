...
**[Download the latest release here.](https://github.com/steeb-k/phoenix-simulacra-binaries/releases/latest)**  Installer and portable ZIP, x64 + ARM64 in one download.
